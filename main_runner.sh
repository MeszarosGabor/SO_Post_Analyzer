...
for language in "${languages[@]}"; do
  echo "Doing $language"
  python3 generate_extracted_import_metadata.py -t $language -x -j data/results/$language/all_${language}_so_posts.jsonl -o data/results/${language}/${language} --max_year 2015
  sleep 1
